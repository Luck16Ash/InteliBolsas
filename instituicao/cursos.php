  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
      <div class="navbar-nav ms-auto">
        <a class="nav-link NavTexto" href="../publico/home.php#sobre">Quem Somos</a>
        <a class="nav-link NavTexto" href="../publico/home.php#destaques">Oportunidades</a>
      ...
      <ul id="lista" class="list-group">
        <?php while($curso = $result->fetch_assoc()): ?>
          <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap"
            ...
            <form method="POST" action="..\aluno\inscricao.php" class="mb-2 mb-md-0 d-flex align-items-center gap-2">
